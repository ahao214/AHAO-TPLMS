        ...
        if (rows.length > 0) {
            $.messager.confirm("提示", "确定要删除吗?", function (res) {
                if (res) {
                    ...
                    $.post("/CargoMgr/Delete", { "ids": codes.join(',') }, function (data) {
                        if (data == "OK") {
        ...
        if (id == "" || id == undefined) {
            ...
            $.messager.confirm('确认', '您确认要保存吗？', function (r) {
                if (r) {
                    ...
                    $.post("/CargoMgr/Add", postData, function (data) {
                       // alert(data);
...
function saveDetail() {
    ...
    $.messager.confirm('确认', '您确认要修改吗？', function (r) {
            ...
            //}
            $.post("/CargoMgr/Update", postData, function (data) {
               // alert(data);
                if (data=="OK") {
...
function GetCargo() {    
    var postData = {
        ...
        "CreateTime": $("#CreateTimeUpdate").val(),
